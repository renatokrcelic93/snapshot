...
class OrgSliderComponent extends React.Component {
  state = {
    backgroundColor: "#fff",
    paddingTop: "0",
    paddingBottom: "0",
  ...
  render() {
    ...
    const settings = {
      className: "org-slider variable-width",
      dots: true,
      infinite: true,
      centerMode: true,
      slidesToShow: 8,
    ...
    return (
      <div className="container-fluid hub">
        <div id="general_container" className="slider-root">
          <div className="row">
            <div className="col-6 text-left margin-bottom-15">
          ...
          <style jsx>{`
            ...
            :global(.org-slider > .slick-list > .slick-track) {
...
export default connect(null)(OrgSliderComponent);
