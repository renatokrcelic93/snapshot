...
class JoinProjectClose extends React.Component {
  ...
  render() {
    const {
      joinProjectData: { project, guestCounter }
    } = this.props;
    const approvalRequired =
      project.participant_approval_required || guestCounter > 5;
    return (
      <div id="project_join_green_container" className="root">
        {!approvalRequired && (
          <div>
            <img
              ...
              src="../../static/celebration-icon.png"
            />
            <h2 id="project_join_green_signedup">You are signed up!</h2>
            <p>We've emailed you all the details. </p>
            <p>
              Make sure to download the VOMO app to get reminders and instant
              updates for this project. You'll also be able to check-in on the
              day of your project.{" "}
            </p>
          </div>
        )}
        {approvalRequired && (
          <div>
            <img className="alert_icon" src="../../static/waiting.svg" />
            <h2 id="project_join_green_signedup">Waiting for approval.</h2>
            <p>The organizer has been notified of your registration.</p>
            <p>You will be notified once the organizer has made a decision.</p>
          </div>
        )}
